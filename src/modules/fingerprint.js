var e = function () {
    return e = Object.assign ||
        function (e) {
            for (var n, t = 1,
                r = arguments.length; t < r; t++) for (var o in n = arguments[t]) Object.prototype.hasOwnProperty.call(n, o) && (e[o] = n[o]);
            return e
        },
            ...
            return function (c) {
                ...
                for (; i && (i = 0, c[0] && (a = 0)), a;) try {
                    if (t = 1, r && (o = 2 & c[0] ? r.
                        return : c[0] ? r.
                            throw || ((o = r.
                                return) && o.call(r), 0) : r.next) && !(o = o.call(r, c[1])).done) return o;
...
function r(e, n, t) {
    if (t || 2 === arguments.length) for (var r, o = 0,
        i = n.length; o < i; o++) !r && o in n || (r || (r = Array.prototype.slice.call(n, 0, o)), r[o] = n[o]);
                ...
                switch (t.label) {
                    case 0:
                        n = Array(e.length),
                            ...
                            t.label = 1;
                    case 1:
                        return c < e.length ? (n[c] = r(e[c], c), (u = Date.now()) >= a + i ? (a = u, [4, o(0)]) : [3, 3]) : [3, 4];
                    case 2:
                        t.sent(),
                            t.label = 3;
                    case 3:
...
function M(e, n) {
    ...
    var r, o = [0, t.length],
        ...
        l = [0, 0],
        s = [0, 0];
    for (r = 0; r < a; r += 16) l[0] = t[r + 4] | t[r + 5] << 8 | t[r + 6] << 16 | t[r + 7] << 24,
...
function R(e, r, o) {
    var i = Object.keys(e).filter((function (e) {
        return !
            function (e, n) {
                for (var t = 0,
                    r = e.length; t < r; ++t) if (e[t] === n) return !0;
                return !1
            }(o, e)
    })),
        a = u(i, (function (n) {
...
function X() {
    var e = window,
        n = navigator;
    return m(["ApplePayError" in e, "CSSPrimitiveValue" in e, "Counter" in e, 0 === n.vendor.indexOf("Apple"), "getStorageUpdates" in n, "WebKitMediaKeys" in e]) >= 4
}
function P() {
    var e = window,
        n = e.HTMLElement,
...
function E() {
    var e, n = window;
    return e = n.print,
        !!/^function\s.*?\{\s*\[native code]\s*}$/.test(String(e)) && m(["[object WebPageNamespace]" === String(n.browser), "MicrodataExtractor" in n]) >= 1
}
function C() {
    var e, n, t = window;
...
function N() {
    var e = j(),
        ...
        r = navigator,
        o = "connection";
    return e ? m([!("SharedWorker" in t), r[o] && "ontypechange" in r[o], !("sinkId" in new window.Audio)]) >= 2 : !!n && m(["onorientationchange" in t, "orientation" in t, /android/i.test(navigator.appVersion)]) >= 2
}
function J(e, r, i) {
    var a, c, u;
...
function _(e) {
    for (var n = function (e) {
        for (var n, t, r = "Unexpected syntax '".concat(e, "'"), o = /^\s*([a-z-]*)(.*)$/i.exec(e), i = o[1] || void 0, a = {},
            c = /([.:#][\w-]+|\[.+?\])/gi, u = function (e, n) {
                a[e] = a[e] || [],
                    a[e].push(n)
            }; ;) {
            var l = c.exec(o[2]);
                            ...
                            return n(this, void 0, void 0, (function () {
                                ...
                                return t(this, (function (t) {
                                    switch (t.label) {
                                        case 0:
                                            return e = window,
                                                (n = e.OfflineAudioContext || e.webkitOfflineAudioContext) ? z() ? [2, -1] : [4, B(n)] : [2, -2];
                                        case 1:
                                            return (r = t.sent()) ? (o = new n(1, r.length - 1 + 4e4, 44100), (i = o.createBufferSource()).buffer = r, i.loop = !0, i.loopStart = (r.length - 1) / 44100, i.loopEnd = r.length / 44100, i.connect(o.destination), i.start(), [4, O(o)]) : [2, -3];
                                        case 2:
                                            return (a = t.sent()) ? (c = function (e, n) {
                                                for (var t = void 0,
                                                    r = !1,
                                                    o = 0; o < n.length; o += Math.floor(n.length / 10)) if (0 === n[o]);
                                                    else if (void 0 === t) t = n[o];
                                                    else if (t !== n[o]) {
                                                        r = !0;
                                                        break
                                                    }
                                                void 0 === t ? t = e.getChannelData(0)[e.length - 1] : r && (t = function (e) {
                                                    for (var n = 1 / 0,
                                                        t = -1 / 0,
                                                        r = 0; r < e.length; r++) {
                                                        var o = e[r];
                                                ...
                                                return t
                                            }(r, a.getChannelData(0).subarray(r.length - 1)), [2, Math.abs(c)]) : [2, -3]
                                    }
                                }))
                            }))
                        }().then((function (n) {
...
function z() {
    return X() && !P() && !(m(["DOMRectList" in (e = window), "RTCPeerConnectionIceEvent" in e, "SVGGeometryElement" in e, "ontransitioncancel" in e]) >= 3);
    var e
}
function B(e) {
    return n(this, void 0, void 0, (function () {
    ...
    return new Promise((function (n, t) {
        ...
        var o = function () {
            try {
                ...
                a(i) && l(i),
                    "suspended" === e.state && (document.hidden || r--, r > 0 ? setTimeout(o, 200) : n(null))
            } catch (c) {
                t(c)
            }
        };
            ...
            switch (t.label) {
                ...
                case 1:
                    return t.sent(),
                        n = $(e),
                        o = $(e),
                        n !== o ? [2, ["unstable", "unstable"]] : (function (e, n) {
                            e.width = 122,
                                e.height = 110,
                                n.globalCompositeOperation = "multiply";
                            for (var t = 0,
                                r = [["#f2f", 40, 40], ["#2ff", 80, 40], ["#ff2", 60, 80]]; t < r.length; t++) {
                                var o = r[t],
                                    i = o[0],
                                    a = o[1],
                                    c = o[2];
        ...
        function () {
            return n(e, void 0, void 0, (function () {
                ...
                return t(this, (function (n) {
                    switch (n.label) {
                        case 0:
                            return ie(e = oe()) ? ne ? [2, r([], ne, !0)] : A() ? [4, (t = document, (t.exitFullscreen || t.msExitFullscreen || t.mozCancelFullScreen || t.webkitExitFullscreen).call(t))] : [3, 2] : [3, 2];
                        case 1:
                            n.sent(),
                                e = oe(),
                                n.label = 2;
...
function ae(e) {
    ...
    return n(this, void 0, void 0, (function () {
        ...
        return t(this, (function (t) {
            switch (t.label) {
                case 0:
                    for (n = document, a = n.createElement("div"), c = new Array(e.length), u = {},
                        ce(a), d = 0; d < e.length; ++d)"DIALOG" === (l = _(e[d])).tagName && l.show(),
...
function ke(e) {
    ...
    for (var r = 0,
        o = ["webgl", "experimental-webgl"]; r < o.length; r++) {
        var i = o[r];
        try {
            n = t.getContext(i)
        } catch (a) { }
...
var Me = {
                    ...
                    switch (t.label) {
                        case 0:
                            return (e = a.body).style.fontSize = "48px",
                                (n = a.createElement("div")).style.setProperty("visibility", "hidden", "important"),
                                r = {},
                                o = {},
                                c = function (e) {
                                ...
                                [4, i()];
                        case 1:
                            for (t.sent(), m = 0; m < U.length; m++) r[U[m]] = d[m].offsetWidth,
                ...
                switch (t.label) {
                    case 0:
                        return X() || N() ? (c = atob, e = {
                            ...
                            n = Object.keys(e), [4, ae((a = []).concat.apply(a, n.map((function (n) {
                                return e[n]
                            }))))]) : [2, void 0];
                    case 1:
                        return o = t.sent(),
        ...
        return function (e, n) {
            ...
            return J((function (t, o) {
                ...
                c.width = "".concat(n, "px"),
                    ...
                    j() ? a.style.zoom = "".concat(1 / o.devicePixelRatio) : X() && (a.style.zoom = "reset");
    ...
    languages: function () {
        ...
        if (void 0 !== r && t.push([r]), Array.isArray(n.languages)) j() && m([!("MediaSettingsRange" in (e = window)), "RTCEncodedAudioFrame" in e, "" + e.Intl == "[object Intl]", "" + e.Reflect == "[object Reflect]"]) >= 3 || t.push(n.languages);
    ...
    timezone: function () {
        ...
        var r, o = (r = (new Date).getFullYear(), -Math.max(d(new Date(r, 0, 1).getTimezoneOffset()), d(new Date(r, 6, 1).getTimezoneOffset())));
    ...
    touchSupport: function () {
        var e, n = navigator,
            t = 0;
        void 0 !== n.maxTouchPoints ? t = s(n.maxTouchPoints) : void 0 !== n.msMaxTouchPoints && (t = n.msMaxTouchPoints);
        try {
    ...
    colorGamut: function () {
        for (var e = 0,
            n = ["rec2020", "p3", "srgb"]; e < n.length; e++) {
            var t = n[e];
    ...
    contrast: function () {
        return se("no-preference") ? 0 : se("high") || se("more") ? 1 : se("low") || se("less") ? -1 : se("forced") ? 10 : void 0
    },
    ...
    webGlExtensions: function (e) {
        ...
        if (t) for (var v = 0,
            h = t; v < h.length; v++) {
            var p = h[v];
            if (!("WEBGL_polygon_mode" === p || "WEBGL_debug_renderer_info" === p && Ze())) {
                ...
                if (b) {
                    ...
                    for (var y = 0,
                        ...
                        var w;
                        m = b[w = g[y]];
                        a.push("".concat(w, "=").concat(m).concat(ge.has(m) ? "=".concat(n.getParameter(m)) : ""))
                    }
                }
            }
        }
        for (var L = 0,
            k = we; L < k.length; L++) for (var V = k[L], S = 0, W = Le; S < W.length; S++) {
                var Z = W[S],
                    x = Ve(n, V, Z);
...
function Fe(e) {
    return M(function (e) {
        for (var n = "",
            t = 0,
            r = Object.keys(e).sort(); t < r.length; t++) {
            var o = r[t],
                i = e[o],
                        ...
                        case 1:
                            return a = t.sent(),
                                c = function (e) {
                                    ...
                                    return {
                                        get visitorId() {
                                            return void 0 === n && (n = Fe(this.components)),
                                                n
                                        },
                                        set visitorId(e) {
                                            n = e
