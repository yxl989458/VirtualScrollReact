                ...
                getToken() ? <Dropdown>
                    <div className="flex gap-4 justify-center items-center">
                        <DropdownTrigger>
                            <div className="flex  gap-4 items-center">  <Avatar size="sm" src="https://i.pravatar.cc/150?u=a042581f4e29026024d" />
                                <span className="text-xl font-bold text-[#828282]">问问用户</span>
                    ...
                    (
                        <div className="w-full flex justify-center gap-10">
                            <Button className="bg-[#828282]  text-white shadow-lg" onClick={() => { openLogin() }} >登录</Button>
                            <Button className="bg-[#828282] text-white shadow-lg" onClick={() => { openRegister() }} >注册</Button>
                        </div>
                    )
            }
        </footer>
